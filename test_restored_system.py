#!/usr/bin/env python3
"""
Test script to verify the original Green Line system is restored.
"""

from route_planner import RoutePlanner

def test_restored_system():
    """Test that the original system is working."""
    planner = RoutePlanner()
    
    print("=== Testing Restored System ===\n")
    ...
    # Test Green Line route (PIMS to Barakahu)
    print("   Green Line: PIMS -> Barakahu")
    from models import RoutePlanningRequest, MetroLine
    green_request = RoutePlanningRequest(
        origin="PIMS",
        destination="Barakahu",
        preferred_time=None,
        max_wait_time=60,
    ...
    # Test Blue Line route (Khanna Pul to NUST)
